...
/*
  edit from TradeApi-M.h:  add delegate
*/ 
#include <Windows.h>
...
typedef int (WINAPI* OpenTdxDelegate)(
    short nClientType,
    const char *pszClientVersion,
    char nCliType,
    char nVipTermFlag,
...
typedef void (WINAPI* CloseTdxDelegate)();
...
typedef int (WINAPI* LogonDelegate)(
    int nQsid,
    const char *pszHost,
    short nPort,
    const char *pszVersion,
...
typedef void (WINAPI* LogoffDelegate)(int nClientID);
...
typedef bool (WINAPI* IsConnectOKDelegate)(int nClientID);
...
typedef int (WINAPI* QueryDataDelegate)(
    int nClientID,
    int nCategory,
    char *pszResult,
    char *pszErrInfo);
...
typedef int (WINAPI* SendOrderDelegate)(
    int nClientID,
    int nCategory,
    int PriceType,
    const char *pszGddm,
...
typedef int (WINAPI* CancelOrderDelegate)(
    int nClientID,
    char nMarket,
    const char *pszHth,
    char *pszResult,
...
typedef int (WINAPI* GetQuoteDelegate)(
    int nClientID,
    const char *pszZqdm,
    char *pszResult,
    char *pszErrInfo);
...
typedef int (WINAPI* QueryHistoryDataDelegate)(
    int nClientID,
    int nCategory,
    const char *pszBeginDate,
    const char *pszEndDate,
...
typedef int (WINAPI* QueryDatasDelegate)(
    int nClientID,
    int nCategory[],
    int nCount,
    char* pszResultOK[],
...
typedef int (WINAPI* SendOrdersDelegate)(
    int nClientID,
    int nCategory[],
    int nPriceType[],
    const char *pszGddm[],
...
typedef int (WINAPI* CancelOrdersDelegate)(
    int nClientID,
    const char nMarket[],
    const char *pszOrderID[],
    int nCount,
...
typedef int (WINAPI* GetQuotesDelegate)(
    int nClientID,
    const char *pszZqdm[],
    int nCount,
    char* pszResultOK[],
