...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LoginWin_t, stringdata) + ofs \
...
void LoginWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->DoOkBtnClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject LoginWin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LoginWin.data,
      qt_meta_data_LoginWin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LoginWin.stringdata))
