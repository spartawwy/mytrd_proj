...
void MsgWin::SetTitle(const QString &str)
{
    setWindowIconText(str);
}

void MsgWin::SetContent(const QString &str)
{
    ui.label_content->setText(str);
}

void MsgWin::ShowUI(const QString &title_str, const QString &str)
{
...
void MsgWin::ShowUI(const std::string &title_str, const std::string &str)
{
    ShowUI(QString::fromLocal8Bit(title_str.c_str()), QString::fromLocal8Bit(str.c_str()));
}

void MsgWin::SlotTimeout()
{
